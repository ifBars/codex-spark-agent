...
cargo run --bin spark -- benchmark-compare --suite real-world --codex-cli-report .spark-profile/codex-cli/real-world-codex-cli-<timestamp>.json --opencode-report .spark-profile/opencode/real-world-opencode-<timestamp>.json
```

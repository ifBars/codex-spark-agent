...
export const wave1ScenarioFixtures = {
  ...
  "failed-validation": { taskId: "proofline-3", validation: "Failed fixture validation", failure: "The deterministic fixture test did not meet its expected assertion.", choices: ["Inspect fixture evidence", "Record failure", "Record a hint"] },
